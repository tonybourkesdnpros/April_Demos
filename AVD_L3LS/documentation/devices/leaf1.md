...
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet3 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet3 | routed | - | - | default | 1500 | False | - | - | - | - |
...
router bgp 65100
   ...
   vrf VRF_A
      ...
      !
      address-family ipv4
         no neighbor 10.255.251.1 next-hop address-family ipv6
```
