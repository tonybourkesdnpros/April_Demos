...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
...
router bgp 65299
   ...
   vrf VRF_A
      ...
      !
      address-family ipv4
         no neighbor 10.255.251.5 next-hop address-family ipv6
```
