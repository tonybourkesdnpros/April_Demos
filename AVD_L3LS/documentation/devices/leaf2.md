...
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
...
| Ethernet6 | default | IPv4-UNDERLAY-PEERS | 65001 | - |
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65100 | - |
...
router bgp 65100
   ...
   neighbor interface Ethernet6 peer-group IPv4-UNDERLAY-PEERS remote-as 65001
   neighbor interface Vlan4093 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65100
   ...
   vrf VRF_A
      ...
      !
      address-family ipv4
         no neighbor 10.255.251.0 next-hop address-family ipv6
```
